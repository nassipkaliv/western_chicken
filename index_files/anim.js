;(function (cjs, an) {
  ...
  // --- Текст поверх ---
  this.text = new cjs.Text("2.20X", "900 36px 'Arial'", "#FFFFFF");
  this.text.lineHeight = 28;
  this.text.textAlign = "center";  
  this.text.setTransform(150, 300);  

  // Добавляем в таймлайн
  this.timeline.addTween(
    cjs.Tween.get({})
      .to({ state: [{ t: this.instance }, { t: this.text }] }) // и картинка, и текст
      .wait(1)
  );
  ...
  ;(lib.Symbol3copy4 = function (mode, startPosition, loop, reversed) {
    ...
    // Layer_7
    this.text = new cjs.Text('2.10X', "900 23px 'Arial'", '#FFFFFF')
    this.text.lineHeight = 28
    this.text.parent = this
    this.text.setTransform(38.85, 59.8)
    this.timeline.addTween(
  ...
  ;(lib.Symbol3copy3 = function (mode, startPosition, loop, reversed) {
    ...
    // Layer_7
    this.text = new cjs.Text('2.00X', "900 23px 'Arial'", '#FFFFFF')
    this.text.lineHeight = 28
    this.text.parent = this
  ...
  ;(lib.Symbol3copy2 = function (mode, startPosition, loop, reversed) {
    ...
    // Layer_7
    this.text = new cjs.Text('1.95X', "900 23px 'Arial'", '#FFFFFF')
    this.text.lineHeight = 28
    this.text.parent = this
  ...
  ;(lib.Symbol3copy = function (mode, startPosition, loop, reversed) {
    ...
    // Layer_7
    this.text = new cjs.Text('1.85X', "900 23px 'Arial'", '#FFFFFF')
    this.text.lineHeight = 28
    this.text.parent = this
    this.text.setTransform(36.65, 59.8)
    this.timeline.addTween(
  ...
  ;(lib.Symbol3 = function (mode, startPosition, loop, reversed) {
    ...
    // Layer_7
    this.text = new cjs.Text('1.50X', "900 23px 'Arial'", '#FFFFFF')
    this.text.lineHeight = 28
    this.text.parent = this
    this.text.setTransform(42.65, 59.8)
    this.timeline.addTween(
  ...
  lib.properties = {
    ...
    opacity: 1.0,
    manifest: [
      { src: './pics/slot_atlas_1.png', id: 'slot_atlas_1' },
    ],
    preloads: [],
  }
